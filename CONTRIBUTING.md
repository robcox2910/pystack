...
| Prefix | When to use |
|--------|-------------|
| `feat/` | New feature or platform component |
| `fix/` | Bug fix |
...
Example: `feat/web-ui`, `fix/plugin-loading`
...
```
feat: add web UI panel for SQL console
fix: resolve plugin discovery on Windows
docs: add integration architecture page
```
...
feat: adds web panel   # not imperative mood ("adds" -> "add")
```
...
Open an issue on [GitHub](https://github.com/robcox2910/pystack/issues) --
we're happy to help!
